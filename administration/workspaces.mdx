...
A workspace is the top-level container for all your work. Each workspace has its own tasks, lists, members, and settings, completely separate from other workspaces.
