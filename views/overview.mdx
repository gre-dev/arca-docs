...
## Views people create most often
...
<Note>
  Views are personal. Each team member creates and manages their own views; you
  only see the views you have created. No one else can see, edit, or delete your
  views.
</Note>
